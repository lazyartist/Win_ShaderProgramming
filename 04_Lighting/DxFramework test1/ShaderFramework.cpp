...
void RenderScene()
{
	...
	const D3DXVECTOR4 gWorldLightPosition = {500.F, 500.F, -500.F, 1.F};
	const D3DXVECTOR4 gWorldCameraPosition = {vEyePt.x, vEyePt.y, vEyePt.z, 1.F};
    ...
    // gpLightingShader->SetTexture("DiffuseMap_Tex1", gpEarthDM); // TextureMapping.fx 파일을 열어보면 변수명이 "DiffuseMap_Tex"로 수정되어 있다.

    // render
    UINT numPass;
    gpLightingShader->Begin(&numPass, 0);
