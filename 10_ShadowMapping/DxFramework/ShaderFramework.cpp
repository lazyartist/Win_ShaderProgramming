...
void RenderScene()
{
    ...
    // shader
    gpApplyShadowShader->SetMatrix("gWorldMatrix", &matWorld);
    gpApplyShadowShader->SetMatrix("gViewMatrix", &matView);
    ...
    // render
    UINT numPass;
    gpApplyShadowShader->Begin(&numPass, 0);
...
bool LoadAssets()
{
    // todo #here
	// 쉐이더 로딩
    gpApplyShadowShader = LoadShader("Lighting.fx");
